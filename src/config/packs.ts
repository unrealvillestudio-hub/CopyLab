...
export const COPY_PACKS: Record<string, CopyPackSpec> = {
  // ─── EMAIL SEQUENCES ──────────────────────────────────────────────────────
  // Motor: Claude (via /api/claude) — no Gemini
  // Sequence awareness: lee content_sequence_pieces antes de generar position > 1
  // Destino: Klaviyo via EF klaviyo-templates-v2
    ...
    jobs: [
      {
        id: "cart_a_es",
        label: "Cart A — ES",
        prompt_type: "prompt_Email_Sequence",
        channel: "EMAIL",
        outputs: 1,
        meta: {
          ...
          language: "ES",
          motor: "claude",
          psycho_presets: ["PSY-TRUST", "PSY-AUTHORITY", "PSY-FOMO"],
          mechanism_primary: "authority_problem_reveal",
          klaviyo_template_slot: "cart_a_es",
        },
      },
      {
        id: "cart_a_en",
        ...
        meta: {
          ...
          psycho_presets: ["PSY-TRUST", "PSY-AUTHORITY", "PSY-FOMO"],
          mechanism_primary: "authority_problem_reveal",
          klaviyo_template_slot: "cart_a_en",
        },
      },
      {
        id: "cart_b_es",
        ...
        meta: {
          ...
          language: "ES",
          motor: "claude",
          psycho_presets: ["PSY-SOCIAL-PROOF", "PSY-SCARCITY", "PSY-BELONGING"],
          mechanism_primary: "social_proof_opportunity_scarcity",
          depends_on: ["cart_a_es"], // leer antes de generar
          klaviyo_template_slot: "cart_b_es",
        },
      },
      {
        id: "cart_b_en",
    ...
    jobs: [
      {
        ...
        meta: {
          ...
          language: "ES",
          motor: "claude",
          psycho_presets: ["PSY-BELONGING", "PSY-ASPIRATION", "PSY-TRUST"],
          mechanism_primary: "belonging_aspiration",
          klaviyo_template_slot: "welcome_es",
        },
      },
      {
        id: "welcome_en",
        ...
        meta: {
          ...
          psycho_presets: ["PSY-BELONGING", "PSY-ASPIRATION", "PSY-TRUST"],
          mechanism_primary: "belonging_aspiration",
          klaviyo_template_slot: "welcome_en",
        },
      },
    ],
  },
    ...
    jobs: [
      {
        ...
        meta: {
          ...
          language: "ES",
          motor: "claude",
          psycho_presets: ["PSY-BELONGING", "PSY-IDENTITY", "PSY-ASPIRATION"],
          mechanism_primary: "education_belonging",
          klaviyo_template_slot: "post_purchase_es",
        },
      },
      {
        id: "post_purchase_en",
        label: "Post Purchase — EN",
        prompt_type: "prompt_Email_Sequence",
        channel: "EMAIL",
        outputs: 1,
        meta: {
          ...
          psycho_presets: ["PSY-BELONGING", "PSY-IDENTITY", "PSY-ASPIRATION"],
          mechanism_primary: "education_belonging",
          klaviyo_template_slot: "post_purchase_en",
        },
      },
    ],
  },
    ...
    jobs: [
      {
        ...
        meta: {
          ...
          language: "ES",
          motor: "claude",
          psycho_presets: ["PSY-SOCIAL-PROOF", "PSY-BELONGING"],
          mechanism_primary: "social_proof_community",
          klaviyo_template_slot: "review_es",
        },
      },
      {
        id: "review_en",
        ...
        meta: {
          ...
          psycho_presets: ["PSY-SOCIAL-PROOF", "PSY-BELONGING"],
          mechanism_primary: "social_proof_community",
          klaviyo_template_slot: "review_en",
        },
      },
    ],
  },

  // ─── EXISTING PACKS (sin cambios) ────────────────────────────────────────
